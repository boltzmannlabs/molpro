...
from geomol_model import GeoMol
...
class Geomol_model_module(pl.LightningModule):
...
def main(params):
    ...
    if params.dataset == "drugs":
        """model_parameters = {'hyperparams': hyperparams,
                            ...
                            'num_edge_features': 4}"""
        model=Geomol_model_module(hyperparams,74,4)
    else :
        """model_parameters = {'hyperparams': hyperparams,
                            'num_node_features': 44,
                            'num_edge_features': 4}"""
        model=Geomol_model_module(hyperparams,num_node_features=44,num_edge_features=4)
    #np.save("model_params.npy",hyperparams)
    #model=Geomol_model_module(hyperparams,num_node_features=74,num_edge_features=4)
