...
from utils.geomol_utils import *
...
class GeoMol(nn.Module):
    ...
    def model_local_stats(self, x, chiral_tag):
        ...
        h_ = h.permute(1, 0, 2, 3).reshape(4, self.n_neighborhoods * self.n_model_confs, self.model_dim * 2)  
    ...
    def align_dihedral_neighbors(self, dihedral_node_reps, dihedral_neighbors, batch, h_mol, dihedral_neighbor_reps):
        ...
        # unpack
        dihedral_x_node_reps, dihedral_y_node_reps = dihedral_node_reps  
        dihedral_x_neighbors, dihedral_y_neighbors = dihedral_neighbors  
        dihedral_x_neighbor_reps, dihedral_y_neighbor_reps = dihedral_neighbor_reps  
